    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Preparacion de Terrenos Asignados</div>
                @if (isset($mensaje))
                        ...
                        @foreach ($preterrenos as $preterreno)
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <a href="{{ url('preparacionterrenos')}}/{{$preterreno['id']}}/edit" class="btn btn-primary btn-xs"><i class="fa fa-btn fa-file-text-o"></i></a>
                                </td>
                            </tr>
                        @endforeach
